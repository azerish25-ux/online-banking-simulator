...
databases** created and dropped around the run (`pf_*` on local PostgreSQL 16 -
never `bankdb`). The PG runs cover the migration chain V1→head, the reconciled-journal
